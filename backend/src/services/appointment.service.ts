...
export class AppointmentService {
  async scheduleAppointment(data: {
    ...
    await customerRepository.updateLifecycleState(data.customerId, data.businessId, 'Booked', 'system:appointment_booking');
  ...
  async cancelAppointment(appointmentId: string, businessId: string, reason?: string): Promise<void> {
    ...
    await customerRepository.updateLifecycleState(appointment.customerId, appointment.businessId, 'Follow-Up Pending', 'system:appointment_cancellation');
  ...
  async completeAppointment(appointmentId: string, businessId: string): Promise<void> {
    ...
    await customerRepository.updateLifecycleState(appointment.customerId, appointment.businessId, 'Customer', 'system:appointment_completed');
