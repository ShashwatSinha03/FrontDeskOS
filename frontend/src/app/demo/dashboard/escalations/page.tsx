...
export default function DemoEscalationsPage() {
  ...
  return (
    <div>
      ...
      <div className="mt-6 rounded-xl border border-amber-500/20 bg-amber-950/10 p-6">
        <div className="flex items-center gap-3">
          ...
          <Link
            ...
            className="ml-auto rounded-lg bg-amber-600 px-4 py-2 text-sm font-medium text-white hover:bg-amber-500"
          >
            View in Inbox
          </Link>
        </div>
