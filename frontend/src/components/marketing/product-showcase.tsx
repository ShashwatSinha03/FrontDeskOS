        ...
        <div className="mx-auto mt-16 grid max-w-4xl gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {items.map((item, i) => {
            ...
            return (
              ...
              >
                <div className="flex h-10 w-10 items-center justify-center rounded-lg border border-zinc-700 bg-zinc-800/50 group-hover:border-blue-500/30">
                  <Icon className="h-5 w-5 text-zinc-400 group-hover:text-blue-400" />
                </div>
