    ...
    <section className="border-t border-zinc-800 bg-black py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl">
          ...
          >
            <div
              className="relative transform-gpu rounded-2xl border border-zinc-700/50 bg-white/[0.03] p-8 backdrop-blur-xl transition-transform duration-200 ease-out sm:p-10"
              style={{
                transform: 'rotateX(var(--rx, 0deg)) rotateY(var(--ry, 0deg))',
              }}
            >
              <svg
                className="absolute left-6 top-6 h-8 w-8 text-zinc-600"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
              ...
              <div className="mt-8 flex items-center gap-4 border-t border-zinc-700/30 pt-6">
