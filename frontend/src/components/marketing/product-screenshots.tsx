...
const VIEWS = [
  ...
  },
  {
    ...
    label: 'Appointments',
    icon: Calendar,
    content: AppointmentsMockup,
  },
  {
    id: 'conversation',
    label: 'Conversations',
    icon: MessageSquare,
    content: ConversationMockup,
  },
];
  ...
  return (
    <div className="space-y-4 p-4 sm:p-6">
      <div className="flex items-center justify-between">
        ...
        <div className="h-7 w-24 rounded-lg border border-zinc-700 bg-zinc-800 px-3 text-[11px] text-zinc-400 flex items-center">
          All States
        </div>
      </div>
  ...
  return (
    <div className="space-y-4 p-4 sm:p-6">
      ...
      <div className="rounded-lg border border-zinc-700 bg-zinc-800/50">
        ...
        {[
          { name: 'Anna K.', service: 'Deep Clean', time: '9:00 AM', status: 'Confirmed' },
          { name: 'Rob M.', service: 'Checkup', time: '10:30 AM', status: 'Confirmed' },
          { name: 'Jenna L.', service: 'Consultation', time: '2:00 PM', status: 'Pending' },
          { name: 'David R.', service: 'Follow-up', time: '3:30 PM', status: 'Cancelled' },
        ].map((appt) => (
          <div
            key={appt.name}
            className="grid grid-cols-4 gap-2 px-3 py-2 text-[11px] text-zinc-300"
