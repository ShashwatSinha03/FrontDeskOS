...
export const HighlightCard: FC<HighlightCardProps> = ({ title, description, icon }) => {
  return (
    <div className="group cursor-pointer transform transition-all duration-500 hover:scale-[1.02] hover:-rotate-1 h-full">
      <Card className="h-full text-white rounded-2xl border border-blue-500/5 bg-gradient-to-br from-[#010101] via-[#090909] to-[#010101] shadow-2xl relative backdrop-blur-xl overflow-hidden hover:border-blue-500/15 hover:shadow-blue-500/5 hover:shadow-3xl">
        ...
        <div className="p-6 relative z-10 flex flex-col items-center text-center h-full">
          <div className="relative mb-5">
            <div className="p-4 rounded-full backdrop-blur-lg border border-blue-500/10 bg-gradient-to-br from-black/80 to-black/60 shadow-2xl transform group-hover:rotate-12 group-hover:scale-110 transition-all duration-500">
          ...
          <h3 className="mb-3 text-lg font-bold bg-gradient-to-r from-blue-400/80 via-blue-300/80 to-blue-400/80 bg-clip-text text-transparent transform group-hover:scale-105 transition-transform duration-300">
            {title}
          </h3>
          ...
          <div className="mt-5 w-1/3 h-0.5 bg-gradient-to-r from-transparent via-blue-400/20 to-transparent rounded-full transform group-hover:w-1/2 transition-all duration-500" />

          <div className="flex space-x-1.5 mt-3 opacity-40 group-hover:opacity-70 transition-opacity duration-300">
