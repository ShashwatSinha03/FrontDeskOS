# FrontDeskOS — Tenant Isolation & Security Audit
...
This audit inspected every route, controller, repository, and service in the FrontDeskOS backend for tenant isolation vulnerabilities, SQL injection, and prompt injection.
