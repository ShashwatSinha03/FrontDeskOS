...
**Goal:** Build a multi-tenant, customer-facing mini website for FrontDeskOS clinics with Home, Services, Book Appointment, Contact pages, embeddable chat widget, and session-based customer tracking.
