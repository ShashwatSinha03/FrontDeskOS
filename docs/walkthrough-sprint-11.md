# FrontDeskOS — Platform Walkthrough & Audit (Sprint 11)
...
1. Navigate to `https://frontdeskos.vercel.app/login`
...
1. Same login as owner: `https://frontdeskos.vercel.app/login`
...
1. Navigate to `/{slug}` (e.g. `https://frontdeskos.vercel.app/brightsmile`)
...
8. Share the login URL (`https://frontdeskos.vercel.app/login`) and password with the owner
9. Share their admin URL (`https://frontdeskos.vercel.app/{slug}/admin`)
10. Share their booking URL (`https://frontdeskos.vercel.app/{slug}/book`)
...
- [ ] Frontend (`https://frontdeskos.vercel.app`) loads the marketing page
